...
class InvyCalculator(qtc.QObject):
    ...
    def run_program(self):
        ...
        # Sort opportunities by highest $ value, filter for >0 $ value
        self.share_status.emit("Finalizing opportunities...")
        self.shares = self.shares[self.shares["Share Value"] > 0].sort_values("Share Value", ascending=False)
...
class MainWindow(qtw.QMainWindow):
    ...
    def setup_UI(self):
        ...
        # Footer Label
        footer_msg = "Version " + version
        footer_msg += ". Maintained by Matt Burns (matthew.burns@te.com)."
    ...
    def program_ready(self, filename, opps):
        ...
        self.progress_label_stylesheet = """
            ...
            color: black;
        """
        self.revenue_label.setText("Revenue Found: $0")
    ...
    def program_run(self):
        ...
        msg += "{:,}".format(self.opportunities) + " opportunities reviewed, "
        msg += "${:,}".format(self.rev_gen) + " in revenue found."
        qtw.QMessageBox.information(self, "Program Complete", msg)
